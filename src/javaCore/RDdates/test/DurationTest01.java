...
public class DurationTest01 {
	public static void main(String[] args) {
		/* ÓTIMO PARA CALCULO DE DATAS
		 * PORÉM NÃO HÁ COMO UTILIZAR O "LocalDate/LocalDateTime" NA DURATION
		 * POIS ESSAS FUNÇÕES NÃO POSSUEM "SEGUNDOS" E NEM "NANO_SEGUNDOS"
		 * */
